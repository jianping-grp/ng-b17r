...
@Component({
  selector: 'app-target-network-table',
  templateUrl: './target-network-table.component.html',
  styleUrls: ['./target-network-table.component.css']
})
export class TargetNetworkTableComponent implements OnInit, AfterViewInit {
  ...
  allColumns = [
    ...
    'second_target_organism', 'shared_molecules'
  ];
