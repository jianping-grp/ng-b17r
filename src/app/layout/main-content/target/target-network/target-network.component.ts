...
export class TargetNetworkComponent implements OnInit {
  ...
  //network
  chartOption:any;
  target_types:any={'ADMET':'#DB8275','CELL-LINE':'#FFD700','CHIMERIC PROTEIN':'#FFC0CB','LIPID':'#FFA500','MACROMOLECULE':'#FF69B4','METAL':'#F0FFFF',
    'MOLECULAR':'#DEB887','NO TARGET':'#99FFFF','NON-MOLECULAR':'#9999FF','NUCLEIC-ACID':'#9900FF','OLIGOSACCHARIDE':'#6699FF','ORGANISM':'#66CCCC','PHENOTYPE':'#920092',
    'PROTEIN':'#546570','PROTEIN COMPLEX':'#000066','PROTEIN COMPLEX GROUP':'#0000FF','PROTEIN FAMILY':'#006600','PROTEIN NUCLEIC-ACID COMPLEX':'#00FF99',
    'PROTEIN-PROTEIN INTERACTION':'#00BFFF','SELECTIVITY GROUP':'#999900','SINGLE PROTEIN':'#D2691E','SMALL MOLECULE':'#660000','SUBCELLULAR':'#33FF00',
    'TISSUE':'#696969','UNCHECKED':'#6A5ACD','UNDEFINED':'#808000','UNKNOWN':'#B0C4DE'
  };
